...
import SlotGraphControls from "../../components/charts/SlotGraphControls";
import { NoGraphData } from "./BasicGraphControls";
import { useParams } from "react-router-dom";

export default function ChargingProgressChart({device, module, token}) {
    ...
    const handleRequest = (params) => {
        ...
        let path = API + "/device/" + device.id + "/progress"
    ...
    return(
        <main className="mh-100">
            <h1 className="section-title">Charging progress</h1>
            <SlotGraphControls updateFlag={flag} callback={handleRequest} slots={module.slots}/>
            {
